...
export const Default: Story = {
  ...
  render: (args) => (
    <_HStack {...args}>
      <Box background="main" padding={3}>
        HStack Item 1
      </Box>
      <Box background="blackAlpha" padding={3}>
        HStack Item 2
      </Box>
      <Box background="main" padding={3}>
        HStack Item 3
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        >
          ...
          <Box background="main" padding={4}>
            Medium
            <br />
            Height
          </Box>
          <Box background="main" padding={6}>
            Large
            <br />
            Content
            <br />
    ...
    <div style={{ width: "300px" }}>
      <_HStack {...args} style={{ background: "#f0f0f0", padding: "10px" }}>
        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
          <Box key={i} background="main" padding={3}>
            Item {i}
          </Box>
        ))}
      </_HStack>
...
export const NavigationBar: Story = {
  render: () => (
    ...
    >
      ...
      <_HStack gap={8}>
        <Box background="main" padding={2} style={{ borderRadius: "4px" }}>
          Sign In
        </Box>
        <Box
...
export const Toolbar: Story = {
  render: () => (
    ...
    >
      ...
      <Box background="blackAlpha" padding={2} style={{ borderRadius: "4px" }}>
        Link
      </Box>
      <Box background="blackAlpha" padding={2} style={{ borderRadius: "4px" }}>
        Image
