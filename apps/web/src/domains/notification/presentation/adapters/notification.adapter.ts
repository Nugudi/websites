...
function getCategoryUiType(category: NotificationCategory): NotificationType {
...
function generateLink(resourceId: string, resourceType: string): string {
...
export const NotificationAdapter = {
  ...
  toUiItem(notification: Notification): NotificationItem {
    return {
      ...
      type: getCategoryUiType(notification.getType()),
