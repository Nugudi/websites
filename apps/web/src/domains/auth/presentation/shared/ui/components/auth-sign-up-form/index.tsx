...
import { useSignUpStore } from "@auth/presentation/client/stores";
import { TOTAL_SIGN_UP_STEPS } from "@auth/presentation/shared/constants";
...
export const AuthSignUpForm = () => {
   ...
   * - useSignUpStore 자체를 의존성에 추가하면 store의 모든 상태 변경 시 재실행되어 불필요한 렌더링 발생
