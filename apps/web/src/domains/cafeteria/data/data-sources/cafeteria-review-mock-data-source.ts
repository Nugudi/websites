 ...
 *
 * Note: 실제 API 구현 시 CafeteriaReviewRemoteDataSource로 교체
 */
 ...
 * Remote DataSource와 동일한 인터페이스 구현
 */
export interface CafeteriaReviewDataSource {
 ...
 */
export class CafeteriaReviewMockDataSource
