/**
 * Benefit DI Container Barrel Export
 *
 ...
 *
 * // index.ts
 * export * from "./benefit-container"; // ✅ Safe - only function references
 * ```
 *
