/**
 * Benefit Mock DataSource Implementation
 *
 * Infrastructure Layer의 Mock DataSource 구현
 *
 * @remarks
 * - Mock 데이터로 API 응답 시뮬레이션
 * - 실제 API 구현 시 benefit-remote-data-source-impl.ts로 교체
 * - Clean Architecture: Infrastructure Layer
 */

import type { BenefitRemoteDataSource } from "../../repository/datasource/benefit-remote-data-source";
import type { BenefitDTO, GetBenefitListResponseDTO } from "../dto";
 ...
 * - Repository에서 사용
 */
export class BenefitMockDataSource implements BenefitRemoteDataSource {
